...
import { FAVORITE_ROUTE, REQUIREMENT_ROUTE, CONTACTS_ROUTE, BASKET_ROUTE} from '../utils/consts';
    ...
    <Wrapper>
      <FooterBlock>
        <FooterContent>
          ...
          <FlexBox1>
            <FooterNavLink to={FAVORITE_ROUTE}>{t('favourites')}</FooterNavLink>
            <FooterNavLink to={BASKET_ROUTE}>{t('cart')}</FooterNavLink>
            <FooterNavLink to={CONTACTS_ROUTE}>{t('сontacts')}</FooterNavLink>
          </FlexBox1>
          <FlexBox2>
            <FooterNavLink to={REQUIREMENT_ROUTE}>{t('requirement')}</FooterNavLink>
            <LangBlock>
